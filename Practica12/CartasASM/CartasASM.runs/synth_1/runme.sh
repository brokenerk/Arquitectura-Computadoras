...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica12/CartasASM/CartasASM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CartasASM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CartasASM.tcl
