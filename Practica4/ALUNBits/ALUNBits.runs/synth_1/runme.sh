...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica4/ALUNBits/ALUNBits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUNBits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALUNBits.tcl
