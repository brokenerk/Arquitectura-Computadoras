...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica4/ALUNBits/ALUNBits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUNBits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALUNBits.tcl -notrace
