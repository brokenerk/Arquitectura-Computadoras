...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica3/SumAcarrAnt/SumAcarrAnt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_AnticNbits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_AnticNbits.tcl -notrace
