...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica2/SumResNBits/SumResNBits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_resNbits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_resNbits.tcl
