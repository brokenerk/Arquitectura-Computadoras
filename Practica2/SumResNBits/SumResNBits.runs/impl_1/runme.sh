...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica2/SumResNBits/SumResNBits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_resNbits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_resNbits.tcl -notrace
