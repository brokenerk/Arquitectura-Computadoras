...
HD_PWD='C:/Users/YaKerTaker/Google Drive/8vo/Arquitectura-Computadoras/Practica11/Pila_MemPrograma/Pila_MemPrograma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pila_MemPrograma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pila_MemPrograma.tcl
